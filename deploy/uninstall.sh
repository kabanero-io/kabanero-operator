...
CRDS=(appsody.dev openliberty.io kabanero.io tekton.dev knative.dev istio.io maistra.io kiali.io jaegertracing.io)
...
# Tekton Dashboard
curl -s -L https://github.com/tektoncd/dashboard/releases/download/v0.6.1.4/openshift-tekton-webhooks-extension-release.yaml | sed "s/openshift-pipelines/tekton-pipelines/" | oc delete --ignore-not-found -f -
curl -s -L https://github.com/tektoncd/dashboard/releases/download/v0.6.1.4/openshift-tekton-dashboard-release.yaml | sed "s/openshift-pipelines/tekton-pipelines/" | oc delete --ignore-not-found -f -
...
unsubscribe open-liberty-certified openshift-operators
...
OPERATORS=(appsody-operator open-liberty-operator jaeger-operator kiali-operator openshift-pipelines-operator serverless-operator servicemeshoperator elasticsearch-operator)
