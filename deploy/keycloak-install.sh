...
if [[ ${ssotemplate} ]]; then
   echo ""
   echo "Copyng the template ${ssotemplate} to json file ..."
   ...
   echo "Processing the template json to create objects - keycloak deploymentconfig, postgresql deploymentconfig, keycloak services, postgresql service, keycloak route, and postgresql pvc ..."
