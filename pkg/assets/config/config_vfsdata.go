...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 9, 17, 16, 25, 36, 467505355, time.UTC),
		},
		...
		"/orchestrations/kappnav/0.1": &vfsgen۰DirInfo{
			name:    "0.1",
			modTime: time.Date(2019, 9, 17, 16, 25, 36, 459904712, time.UTC),
		},
		...
		"/orchestrations/landing/0.1": &vfsgen۰DirInfo{
			name:    "0.1",
			modTime: time.Date(2019, 9, 15, 14, 51, 26, 214555773, time.UTC),
		},
		...
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 9, 16, 20, 9, 58, 272525075, time.UTC),
		},
		...
		"/samples/full.yaml": &vfsgen۰CompressedFileInfo{
			name:             "full.yaml",
			modTime:          time.Date(2019, 9, 16, 18, 13, 5, 519200774, time.UTC),
		...
		"/versions.yaml": &vfsgen۰CompressedFileInfo{
			name:             "versions.yaml",
			modTime:          time.Date(2019, 9, 17, 16, 25, 36, 468621135, time.UTC),
