...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 18, 21, 20, 32, 459894868, time.UTC),
		},
		...
		"/orchestrations": &vfsgen۰DirInfo{
			name:    "orchestrations",
			modTime: time.Date(2019, 10, 2, 21, 20, 4, 930918371, time.UTC),
		},
		...
		"/orchestrations/appsody-operator": &vfsgen۰DirInfo{
			...
			modTime: time.Date(2019, 10, 1, 23, 12, 48, 57896286, time.UTC),
		},
		"/orchestrations/appsody-operator/0.1": &vfsgen۰DirInfo{
			name:    "0.1",
			modTime: time.Date(2019, 9, 22, 13, 56, 2, 246547412, time.UTC),
		},
		...
		"/orchestrations/appsody-operator/0.2": &vfsgen۰DirInfo{
			name:    "0.2",
			modTime: time.Date(2019, 10, 1, 23, 12, 48, 58041858, time.UTC),
		},
		"/orchestrations/appsody-operator/0.2/appsody.yaml": &vfsgen۰CompressedFileInfo{
			name:             "appsody.yaml",
			modTime:          time.Date(2019, 10, 1, 23, 12, 48, 58186419, time.UTC),
		...
		"/orchestrations/che/0.1": &vfsgen۰DirInfo{
			name:    "0.1",
			modTime: time.Date(2019, 10, 2, 21, 20, 4, 932612014, time.UTC),
		},
		...
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 10, 18, 21, 32, 52, 759563185, time.UTC),
		},
		...
		"/samples/collection.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 10, 18, 21, 29, 51, 425756116, time.UTC),
		...
		"/samples/full.yaml": &vfsgen۰CompressedFileInfo{
			name:             "full.yaml",
			modTime:          time.Date(2019, 10, 18, 21, 31, 59, 331951253, time.UTC),
		...
		"/versions.yaml": &vfsgen۰CompressedFileInfo{
			name:             "versions.yaml",
			modTime:          time.Date(2019, 10, 18, 21, 20, 32, 460744159, time.UTC),
