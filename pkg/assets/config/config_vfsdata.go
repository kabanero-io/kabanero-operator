...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 10, 4, 14, 3, 28, 675153077, time.UTC),
		},
		...
		"/samples/collection.yaml": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2019, 10, 4, 14, 3, 28, 674894505, time.UTC),
		...
		"/samples/full.yaml": &vfsgen۰CompressedFileInfo{
			name:             "full.yaml",
			modTime:          time.Date(2019, 10, 4, 14, 3, 28, 676811831, time.UTC),
