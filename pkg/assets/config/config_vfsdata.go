...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 11, 1, 1, 16, 12, 933058110, time.UTC),
		},
		...
		"/orchestrations": &vfsgen۰DirInfo{
			name:    "orchestrations",
			modTime: time.Date(2019, 10, 25, 15, 17, 1, 339221407, time.UTC),
		},
		...
		"/orchestrations/che/0.1": &vfsgen۰DirInfo{
			name:    "0.1",
			modTime: time.Date(2019, 11, 1, 1, 33, 54, 567934773, time.UTC),
		},
		"/orchestrations/che/0.1/che-operator-crd.yaml": &vfsgen۰CompressedFileInfo{
			name:             "che-operator-crd.yaml",
			modTime:          time.Date(2019, 11, 1, 1, 16, 12, 931977402, time.UTC),
		...
		"/orchestrations/che/0.1/che-operator.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 11, 1, 1, 16, 12, 932312307, time.UTC),
		...
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 11, 1, 5, 47, 0, 565907349, time.UTC),
		},
		...
		"/samples/full.yaml": &vfsgen۰CompressedFileInfo{
			name:             "full.yaml",
			modTime:          time.Date(2019, 11, 1, 5, 47, 0, 566121174, time.UTC),
		...
		"/versions.yaml": &vfsgen۰CompressedFileInfo{
			name:             "versions.yaml",
			modTime:          time.Date(2019, 11, 1, 1, 16, 12, 933168740, time.UTC),
			uncompressedSize: 2860,
