...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 25, 15, 17, 1, 340572037, time.UTC),
		},
		...
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 10, 28, 20, 4, 29, 63746667, time.UTC),
		},
		...
		"/samples/full.yaml": &vfsgen۰CompressedFileInfo{
			name:             "full.yaml",
			modTime:          time.Date(2019, 10, 28, 20, 4, 29, 63947107, time.UTC),
		...
		"/versions.yaml": &vfsgen۰CompressedFileInfo{
			name:             "versions.yaml",
			modTime:          time.Date(2019, 10, 25, 15, 17, 1, 340685688, time.UTC),
