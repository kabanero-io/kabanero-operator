...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 20, 4, 5, 46, 497042298, time.UTC),
		},
		...
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 10, 21, 18, 48, 22, 342254736, time.UTC),
		},
		...
		"/samples/full.yaml": &vfsgen۰CompressedFileInfo{
			name:             "full.yaml",
			modTime:          time.Date(2019, 10, 21, 16, 52, 32, 492284550, time.UTC),
