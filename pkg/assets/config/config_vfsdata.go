...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 24, 21, 34, 28, 657689151, time.UTC),
		},
		...
		"/orchestrations": &vfsgen۰DirInfo{
			name:    "orchestrations",
			modTime: time.Date(2019, 10, 24, 21, 34, 28, 655992850, time.UTC),
		},
		...
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 10, 24, 21, 34, 28, 657213151, time.UTC),
		},
		...
		"/versions.yaml": &vfsgen۰CompressedFileInfo{
			name:             "versions.yaml",
			modTime:          time.Date(2019, 10, 24, 21, 34, 28, 657838593, time.UTC),
