...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 25, 15, 2, 27, 769200529, time.UTC),
		},
		"/orchestrations": &vfsgen۰DirInfo{
			name:    "orchestrations",
			modTime: time.Date(2019, 10, 25, 15, 2, 27, 791200425, time.UTC),
		},
		...
		"/samples/collection.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 10, 21, 15, 28, 15, 180370227, time.UTC),
		...
		"/samples/default.yaml": &vfsgen۰CompressedFileInfo{
			name:             "default.yaml",
			modTime:          time.Date(2019, 10, 21, 15, 28, 15, 182370218, time.UTC),
