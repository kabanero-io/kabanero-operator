...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheOperatorSpec) DeepCopyInto(out *CheOperatorSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheOperatorSpec.
func (in *CheOperatorSpec) DeepCopy() *CheOperatorSpec {
	if in == nil {
		return nil
	}
	out := new(CheOperatorSpec)
	in.DeepCopyInto(out)
	return out
}
